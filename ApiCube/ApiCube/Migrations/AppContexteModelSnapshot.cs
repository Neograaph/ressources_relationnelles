            ...
            modelBuilder.Entity("ApiCube.Models.BuisnessObjects.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UtilisateurId = 1,
                            AdresseId = 1,
                            DateCreation = new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8078),
                            DateNaissance = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DerniereConnexion = new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8111),
