    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 6, 12, 15, 3, 11, 7, DateTimeKind.Local).AddTicks(311), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 6, 12, 15, 3, 11, 7, DateTimeKind.Local).AddTicks(358), "john.doe@example.com", "123456", "John", "Doe", "Utilisateur", "0123456789", true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 2, "Contenu de la ressource", new DateTime(2023, 6, 12, 15, 3, 11, 7, DateTimeKind.Local).AddTicks(529), 1, "Titre de la ressource", 1, 1, true, "Publique" });

            migrationBuilder.InsertData(
                table: "Ressources",
                columns: new[] { "RessourceId", "CategorieId", "Contenu", "DateCreation", "DocumentId", "Titre", "TypeRessourceId", "UtilisateurId", "Valider", "VisibiliteLibelle" },
                values: new object[] { 2, 2, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec sapien sed odio malesuada lobortis sed ut ex. Vestibulum facilisis scelerisque elit, ac commodo magna eleifend id.", new DateTime(2023, 6, 12, 15, 3, 11, 7, DateTimeKind.Local).AddTicks(525), null, "Ressource random", 1, 1, true, "Publique" });
