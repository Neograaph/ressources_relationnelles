    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8078), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8111), "john.doe@example.com", "123456", "John", "Doe", "Utilisateur", "0123456789", true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Contenu de la ressource", new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8336), 1, "Titre de la ressource", 1, 1, true, "Publique" },
                    { 2, 2, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec sapien sed odio malesuada lobortis sed ut ex. Vestibulum facilisis scelerisque elit, ac commodo magna eleifend id.", new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8328), null, "Ressource random", 1, 1, true, "Publique" },
                    { 3, 3, "Contenu de la ressource eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8339), 1, "Test", 4, 1, true, "Publique" },
                    { 4, 5, "Contenu encore", new DateTime(2023, 6, 16, 15, 20, 23, 478, DateTimeKind.Local).AddTicks(8341), 1, "Another post", 1, 1, true, "Publique" }
                });
