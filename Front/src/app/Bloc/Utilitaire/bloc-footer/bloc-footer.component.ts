  ...
  ngOnInit(): void {
    this.router.events.subscribe((routerData) => {
      if(routerData instanceof ResolveEnd){
          ...
          // } else3
           if (this.currentRoute === '/connexion' || this.currentRoute === '/inscription' ) {
            this.footerClass = 'absolute  bottom-0 text-blanc w-full'; // Applique la classe CSS pour rendre la navbar invisible
          } else {
            this.footerClass = ""
          }
        }
